...
namespace BlazorApp1.ComponentsLibrary.Modals
{
    public partial class EmailModal
    {
        ...
        private MailData mailData { get; set; } = new(new List<string>(),string.Empty,string.Empty, string.Empty,string.Empty,string.Empty,string.Empty,new List<string>(), new List<string>());
